		...
		<div className="flex flex-col gap-2.5 text-left">
			<div className="flex items-center justify-between">
				...
				<button
					...
					onClick={addBottle}
					disabled={disabled}
					className="flex items-center gap-1 rounded-full bg-blue-tint px-3 py-1 text-[12px] font-bold text-blue-deep transition-transform active:scale-[0.98] disabled:opacity-60"
				>
