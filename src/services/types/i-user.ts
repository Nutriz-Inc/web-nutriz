...
export interface IUser {
  ...
  update(id_user: string, data: IUpdateUserRequest): Promise<IUpdateUserResponse>;
  ...
  updateAddress(id_address: string, data: IUpdateAddressRequest): Promise<IUpdateAddressResponse>;
  ...
  updateBaby(id_user_baby: string, data: IUpdateUserBabyRequest): Promise<IUpdateUserBabyResponse>;
