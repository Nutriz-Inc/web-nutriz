		...
		>
			...
			<div className="relative z-10 mx-auto grid w-full max-w-[1200px] items-center gap-12 px-5 pt-[calc(7rem+env(safe-area-inset-top))] pb-16 lg:grid-cols-2 lg:gap-10 lg:px-8 lg:pt-36 lg:pb-24">
				<motion.div {...contentReveal} className="flex flex-col items-start">
					...
					<motion.h1
						variants={fadeUp}
						className="mt-6 font-display text-[32px] font-extrabold leading-[1.08] tracking-tight text-white min-[420px]:text-[38px] sm:text-[46px] md:text-[52px] lg:text-[60px]"
					>
						Doar Amor.
						<br />
					...
					>
						...
						<button
							...
							className="inline-flex h-12 items-center rounded-full border border-white/40 bg-transparent px-7 text-[15px] font-semibold text-white transition-colors hover:bg-white/10 focus-visible:ring-3 focus-visible:ring-mint/60"
						>
							Saiba mais
						</button>
					</motion.div>
