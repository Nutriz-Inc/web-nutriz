...
export function MetricCard({
	...
	return (
		<div className="bg-white border border-[#e5ebf3] flex flex-col gap-2 items-start p-6 rounded-[14px] w-full shadow-[0px_10px_14px_rgba(10,38,77,0.05)] lg:flex-1 lg:gap-3.5 lg:p-7">
			<div
