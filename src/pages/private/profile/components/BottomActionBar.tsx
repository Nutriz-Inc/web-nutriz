	...
	return (
		<div className="sticky bottom-0 flex flex-col gap-2 border-t border-ink-3/12 bg-white px-4 py-3 lg:static lg:flex-row-reverse lg:items-center lg:justify-start lg:gap-4 lg:border-none lg:bg-transparent lg:px-0 lg:py-6">
			...
			<button
				...
				onClick={onCancel}
				disabled={saving}
				className="flex h-[38px] w-full items-center justify-center rounded-2xl border border-line text-[14px] text-ink-3 disabled:opacity-70 lg:h-auto lg:w-auto lg:rounded-xl lg:border-none lg:px-7 lg:py-3.5"
			>
				Cancelar
			</button>
		</div>
