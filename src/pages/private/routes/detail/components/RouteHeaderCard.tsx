			...
			<div className="flex items-start justify-between gap-3 p-5">
				...
				{podeGerenciar && (
					<button
						...
						className="flex size-9 shrink-0 items-center justify-center rounded-full text-ink-2 outline-none transition-colors hover:bg-blue-tint hover:text-blue-deep focus-visible:ring-4 focus-visible:ring-blue-bright/50"
					>
